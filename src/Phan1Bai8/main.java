...
//	3) Lấy ra tất cả các chuỗi có chiều dài lớn hơn 4 ký tự trong mảng (kiểu trả về là mảng)
	...
	public static void main(String[] args) {
		...
		String target= "lop";
		String[] str = {"Pham", "Van", "lOp", "Giang", "hoc", "loP", "Cong", "Nghe" ,"Lop", "Thong", "Tin", "LOP", "K62"};
		System.out.println("So lan xuat hien cua chuoi "+target+" la: "+countIndexOfString(str, target));
		System.out.println("Vi tri xuat hien cuoi cung cua chuoi "+target+ " la: "+locationIndexOfString(str, target));
